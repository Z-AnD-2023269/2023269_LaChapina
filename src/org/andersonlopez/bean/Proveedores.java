...
public class Proveedores {
    ...
    public Proveedores(int codigoProveedor, String NITProveedor, String nombresProveedor, String apellidosProveedor, String direccionProveedor,
            String razonSocial, String contactoPrincipal, String paginaWeb) {
        this.codigoProveedor = codigoProveedor;
        this.NITproveedor = NITProveedor;
        this.nombreProveedor = nombresProveedor;
        this.apellidoProveedor = apellidosProveedor;
